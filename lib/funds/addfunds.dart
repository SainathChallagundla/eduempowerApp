...
class _DonarFundsPageState extends State<DonarFundsPage> {
  String referenceNo, moreInfo, token, email, name, paymentMode;
  ...
  Future<void> onSubmit(BuildContext context) async {
    ...
    var result = await fundDetails_helper.FundDetails()
        .addFund(HttpEndPoints.BASE_URL + HttpEndPoints.ADD_FUND, token, funds);
